import pygame
from paskahousu.sprite_sheet import load_sprite_sheet, maarita_alueet, display_kortit,display_kortti
#from kortti import korttien_maara, leveys, korkeus, vali, kokonaisleveys, paikka
from kortti import kortti
from logiikka import deal_hands, create_pakka, shuffle_pakka
...
kasi1, kasi2, loput_kortit, kasi1 = deal_hands(unshuffled_pakka)

#print("Pelaaja 1:", kasi1)
#print("Pelaaja 2:", kasi2)
